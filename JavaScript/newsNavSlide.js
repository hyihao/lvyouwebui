    ...
    (function ($) {
        $.fn.NewsNavSlide = function (options) {
            ...
            function prev() {
                ...
                anim(index, 'prev'); timer = setInterval(next, 5000); 
             }
             function auto() {
                 loading();
                 timer = setInterval(next, 5000); 
            ...
            function loading() {
                ld.css({ "height": "0", "height": "5px", "position": "absolute", "left": "0", "bottom": "0", "background": "#FF4939", "z-index": "10" });
                ld.animate({ "width": "100%" }, 5000).animate({ "width": 0 }, 0);
             }
